...
namespace Quilt
{
    public partial class MainForm
    {
        ...
        void pDoPatternElementUI(object sender, EventArgs e)
        {
            if (UIFreeze)
            {
                return;
        ...
        void pDoPatternElementUI_num(int pattern, int index, string shapeString)
        {
        ...
        void pDoPatternElementUI(int pattern, bool updateUI = false, bool doPreview = true)
        {
            if (UIFreeze)
            {
                return;

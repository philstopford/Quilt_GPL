...
namespace Quilt
{
    public partial class MainForm
    {
        ...
        void pSetSize(Button _control, int width, int height)
        {
        ...
        void pClearPositionBox()
        {
            groupBox_position.Visible = false;
        }

        void pSetupPatternElementUI_2()
        {
        ...
        void pSetupPatternElementUI_4()
        {
            Application.Instance.Invoke(() =>
            {
                ...
                Panel row0 = new Panel {Content = tl};
                ...
                Label bbLeft = new Label {Text = "Left Padding"};
                ...
                Label bbRight = new Label {Text = "Right Padding"};
                ...
                Label bbBottom = new Label {Text = "Bottom Padding"};
                ...
                Label bbTop = new Label {Text = "Top Padding"};

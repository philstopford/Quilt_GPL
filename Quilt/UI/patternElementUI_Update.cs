...
namespace Quilt
{
    ...
    {
        void pUpdatePatternElementUI_subshape(int index)
        {
        ...
        void pMinHLRefSubShapeList_update(int index, int subshapeindex)
        {
        ...
        void pMinVLRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pMinHORefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pMinVORefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pHLStepsRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pVLStepsRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pHOStepsRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pVOStepsRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pHLIncRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pVLIncRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pHOIncRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pVOIncRefSubShapeList_update(int index, int subshapeindex)
        {
            switch (subshapeindex)
            {
                case 0:
        ...
        void pSetReferenceValues(int index, int subshapeindex, ObservableCollection<string> uilist, PatternElement.properties_i targetValue, PatternElement.properties_i propertyIndex, PatternElement.properties_i subShapeIndex, DropDown cb, NumericStepper ns)
        {
            uilist.Clear();
            uilist.Add("1");
        ...
        void pXPosRefSubShapeList_update(int index)
        {
        ...
        void pYPosRefSubShapeList_update(int index)
        {
        ...
        void pUpdatePatternElementUI_positionX(int index)
        {
        ...
        void pUpdatePatternElementUI_positionY(int index)
        {
        ...
        void pUpdatePatternElementUI_position(int index)
        {
        ...
        void pUpdatePatternElementUI_rotation(int index)
        {
        ...
        void pUpdatePatternElementUI_transform(int index)
        {
        ...
        void pUpdatePatternElementUI_array(int index)
        {
            bool isArray = false;
        ...
        void pUpdatePatternElementUI(bool doPreview = true)
        {
            if (UIFreeze)
            {
                return;
        ...
        void pSetBoundingShapeVals(int index)
        {

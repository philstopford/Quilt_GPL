...
public class ComplexShape
{
    ...
    private static PathD pMakeShape(bool returnEarly, ShapeLibrary shape, double hTipBias, double vTipBias)
    {
        PathD mcPoints = [];
        ...
        else
        {
            ...
            const int cornerSegments = 90;
            const int optimizeCorners = 1;
    ...
    private void pMakeEntropyShape(List<PatternElement> patternElements, int settingsIndex, ShapeLibrary shape = null)
    {
        ...
        if (!mcPoints.Any())
        {
            mcPoints.Add(new PointD(0.0f, 0.0f));
        }
